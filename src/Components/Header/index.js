...
function Header() {
  ...
  const getCurrentUser = async () => {
    ...
    setCurrentUserImage(user?.userImageUrl)
    setCurrentUserName(user?.fullName)
    console.log(currentUserName, "user Name........")
  };
      ...
      <div className="mainHeader">
        ...
        <div className="NavbarSection">
          ...
          <div className="input-1">
            ...
            <input className="inputt" placeholder="Search city, area or locality" />
          </div>
          <div className="input-2">
            <input className="inputt" placeholder="Find Cars, Mobile Phones and more..." />
                ...
                <div className="drop-list">
                  <div>
                    ...
                    className="user-img"
                      ...
                      src={currentUserImage || defaultImage}
                    />
                    <span className="usr-name">Hello, {currentUserName}</span>
                  </div>
                  {/* <h4 className="usr-email">{currentUser.email}</h4> */}

                  <button className="profile-update-btnn" onClick={() => navigate(`/UpdateProfile/${currentUser.email}`)}>View and update your profile</button>
                  <h3><span className="iconn"><FontAwesomeIcon icon={faRectangleAd} /></span>My Ads</h3>
                  <h3 onClick={() => navigate("/Cart")}> <span className="iconn"><FontAwesomeIcon icon={faCartShopping} /></span>My Cart</h3>
                  <h3> <span className="iconn"><FontAwesomeIcon icon={faHeart} /></span>Favourites</h3>
                  <h3><span className="iconn"><FontAwesomeIcon icon={faBars} /></span>Settings</h3>
                  <h3> <span className="iconn"><FontAwesomeIcon icon={faCircleQuestion} /></span>Help</h3>

                  <hr />
                  <h4 onClick={logout}> <span className="iconn"> <FontAwesomeIcon icon={faRightFromBracket} /></span>Logout</h4>
                </div>
              </div>
            ) : (
          ...
          <div className="sell">
            <button onClick={() => navigate("/PostAd")}>
              <span><FontAwesomeIcon icon={faPlus} /> SELL</span>
            </button>
          </div>
        </div>
      </div>
